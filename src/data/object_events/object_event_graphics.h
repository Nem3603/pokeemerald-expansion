...
const u32 gObjectEventPic_Bus[] = INCBIN_U32("graphics/object_events/pics/misc/BusSprite.4bpp");
const u16 gObjectEventPalette_Bus[] = INCBIN_U16("graphics/object_events/pics/misc/BusSprite.gbapal");
